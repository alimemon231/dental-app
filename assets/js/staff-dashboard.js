 ...
 * Premium Staff Metrics & Office Performance Layout Engine
 * Handles shared operational indicators and dynamic responsive custom staff widgets arrays.
 */
...
$(document).ready(function () {
    ...
    function loadStaffStatCards() {
        App.ajax({
            url: '/staff-dashboard/dashboard-stats.php', // Utilizing the streamlined office stats endpoint
            method: 'GET',
            loader: false,
    ...
    function loadCustomAnalyticsGrid() {
        App.ajax({
            url: '/staff-dashboard/custom-statics.php',
            method: 'GET',
            loader: false,
