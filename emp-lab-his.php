...
<head>
    ...
    <title>Staff - Lab Case Monitor</title>
...
<body>
            ...
            <div class="page-wrapper">
                <div class="page-header">
                    <div class="page-header-left">
                        <h1>Lab History</h1>
                        <div class="page-header-sub">Clinical lab case status tracking log for your assigned office locations.</div>
                    </div>
                </div>
                ...
                <div class="card mb-6 no-print">
                    ...
                    <div class="flex flex-justify-end gap-2 mt-4">
                        <button class="btn btn-ghost btn-sm" id="btn-clear"><i class="fa-solid fa-xmark"></i> Clear</button>
    ...
    <script src="assets/js/emp-lab-monitor.js"></script>
</body>
