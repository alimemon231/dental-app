 ...
 * Fetches every piece of information by joining relevant tables:
 * - offices (o): Location name
 * - users (u1): The Provider/Doctor
 * - users (u2): The staff who created the record
 * - users (u3): The staff who marked it as received
 * - case_types (ct): Category of the lab work
 * - procedures (proc): Planned procedure for next visit
 */
$sql = "SELECT 
            l.*, 
