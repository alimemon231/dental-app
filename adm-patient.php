<?php
/**
 * Admin Panel - Comprehensive Patient Management Lifecycle Matrix
 * admin-patient.php
 */
?>
<!DOCTYPE html>
...
<body>
            ...
            <div class="page-wrapper">
                <div class="page-header">
                    <div class="page-header-left">
                        <h1>Manage Patients (Admin)</h1>
                        <div class="page-header-sub">Global administrative overview and lifecycle control of all clinical records.</div>
                    </div>
                            ...
                            <tr>
                                <td colspan="7">
                                    <div class="table-empty">
                                        <i class="fa-solid fa-spinner fa-spin"></i> Loading data stream...
                                    </div>
                                </td>
                            </tr>
                        </tbody>
                            ...
                            <form id="patient-form" autocomplete="off" novalidate>
                                ...
                                <div class="form-section">
                                    <div class="form-section-title">
                                        <i class="fa-solid fa-id-card"></i> Patient Profile Information
                                    </div>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group">
                                            ...
                                            <input type="tel" name="phone" id="phone" class="form-control" placeholder="e.g. +1 (555) 000-0000" required>
                                            <span class="form-error">Phone number is required.</span>
                                        </div>
                                        <div class="form-group">
                                            <label class="form-label">Email Address</label>
                                            <input type="email" name="email" id="email" class="form-control" placeholder="e.g. jane.doe@example.com">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group">
                                            ...
                                            <span class="form-error">Please choose an assigned office destination.</span>
                                        </div>
                                        <div class="form-group">
                                            <label class="form-label">Full Residential Address <span class="required">*</span></label>
                                            <input type="text" name="address" id="address" class="form-control" placeholder="e.g. Apt 4B, 123 Main Street, New York" required>
                ...
                <div class="modal-backdrop" id="view-history-modal">
                    <div class="modal modal-xl" style="max-width: 1000px;">
                        <div class="modal-header">
                            <div class="modal-title"><i class="fa-solid fa-clock-rotate-left"></i> Comprehensive Patient History</div>
                        ...
                        <div class="modal-body" style="background-color: #f8fafc; padding: var(--sp-6);">
                            <div class="grid-2" style="gap: var(--sp-6);">
                                <div>
                                    <div class="form-section-title mb-4" style="color: var(--color-primary); border-bottom: 2px solid #e2e8f0; padding-bottom: 8px;">
                                        <i class="fa-solid fa-shield-halved"></i> Pre-Authorization History
                                    </div>
                                    <div id="history-preauth-container" style="max-height: 500px; overflow-y: auto; padding-right: 5px;">
                                        <div class="text-muted text-center p-4">
                                            <i class="fa-solid fa-spinner fa-spin"></i> Loading pre-auth records...
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div id="history-labs-container" style="max-height: 500px; overflow-y: auto; padding-right: 5px;">
                                        <div class="text-muted text-center p-4">
                                            <i class="fa-solid fa-spinner fa-spin"></i> Loading lab cases...
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script src="assets/js/adm-patients.js"></script>
    <script>
        $(document).ready(function () {

            /* 1. Establish Session Guard to Admin Level Role Strictness */
            App.auth.check();
            App.auth.role('admin');

            /* 2. Hydrate Active Sidebar Branding Component Contexts */
            App.ajax({
                url: '/auth/check.php',
                loader: false,
                silent: true,
                onSuccess: function (d) {
                    if (d && d.user) {
                        ...
                        $('#sidebar-user-role').text(d.user.role || 'Admin');
