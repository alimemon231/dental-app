        ...
        <div class="page-header">
          ...
          <div class="page-header-actions">
            <button class="btn btn-primary" id="btn-add-patient">
              <i class="fa-solid fa-users"></i> Add Staff
            </button>
          </div>
        </div>
        ...
        <div class="modal-backdrop" id="patient-modal">
          <div class="modal modal-lg">
            <div class="modal-header">
              <div class="modal-title" id="patient-modal-title">Add New Staff</div>
            ...
            <div class="modal-body">
              <form id="patient-form" novalidate>
                ...
                <div class="form-section">
                  <div class="form-section-title"><i class="fa-solid fa-hospital"></i> Staff Information</div>
                  <div class="form-row">
                    <div class="form-group">
                      <label class="form-label">Staff Name <span class="required">*</span></label>
                      <input type="text" name="name" id="name" class="form-control" placeholder="e.g. Staff 1"
                        required>
                      <span class="form-error">Staff name is required.</span>
                    </div>
                    <div class="form-group">
                  ...
                  <div class="form-row">
                    <div class="form-group">
                      ...
                      <input type="text" name="username" id="username" class="form-control" placeholder="e.g andrewstaff"
                        required>
                        <small>username must be unique not matched with any other user</small>
            ...
            <div class="modal-footer">
              ...
              <button class="btn btn-primary" id="btn-save-staff">
